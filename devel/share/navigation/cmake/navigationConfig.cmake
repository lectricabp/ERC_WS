...
if(NOT "/home/upcspjetson/Desktop/ERC_WS/devel/include " STREQUAL " ")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/upcspjetson/Desktop/ERC_WS/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/upcspjetson/Desktop/ERC_WS/src/navigation/${idir}'.  ${_report}")
    endif()
...
set(depends "cv_bridge;opencv2;rospy;sensor_msgs;std_msgs;message_runtime")
