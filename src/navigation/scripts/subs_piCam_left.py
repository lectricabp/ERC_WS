...
def listener():
    rospy.init_node('cam_pos_piCam_left', anonymous = False)
    rospy.Subscriber("/piCam/left/image_raw",Image, callback)
...
def pose_estimation(frame):
    ...
    pub = rospy.Publisher('/left/pos_piCam',Position, queue_size=100)
