...
def listener():
    rospy.init_node('cam_pos_piCam_right', anonymous = False)
    rospy.Subscriber("/piCam/right/image_raw",Image, callback)
...
def pose_estimation(frame):
    ...
    pub = rospy.Publisher('/right/pos_piCam',Position, queue_size=100)
